                ...
                <section className={styles.form}>
                    ...
                    <form onSubmit={handleSubmit((data) => console.log(data))}>
                        <section className={styles.inputs}>
                            ...
                            <input {...register("name", { required: true, minLength: 3, maxLength: 10 })} className={styles.input} type="text" />
                        ...
                        <section className={styles.inputs}>
                            ...
                            <input {...register("lastname", { required: true, minLength: 3, maxLength: 10 })} className={styles.input} type="text" />
                        ...
                        <section className={styles.inputs}>
                            ...
                            <input {...register("age", { required: true, validate: ageValidator })} className={styles.input} type="number" />
                        ...
                        <section className={styles.inputs}>
                            ...
                            <input {...register("email", { required: true, pattern: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i })} className={styles.input} type="email" />
                        ...
                        <section className={styles.inputs}>
                            ...
                            <input {...register("mensaje", { required: false })} className={styles.input} type="text" />
                        </section>
                        <section className={styles.inputs}>
                            <label className={styles.label}>Hoja de Vida</label>
                            <input {...register("file", { required: true })} className={styles.input} type="file"  />
                        </section>
                        <section className={styles.inputs}>
