                ...
                <div className={styles.contenido}>
                    <div className={styles.container}>
                        ...
                        <p className='texto'>
                            ...
                            jsndjasndjnsajd Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rem aspernatur nisi, accusantium quisquam est assumenda magni, quibusdam sapiente natus cupiditate quidem architecto officia quos ad, quod fugiat vitae amet delectus.
                        </p>
                    </div>
                    ...
                    <section>
                        <button onClick={() => navigate('/Events')} className={styles.borderButton}>
                            <div className={styles.sectionButton}>
                                ...
                                <div className={styles.sectionBotones}><h3>Eventos</h3></div>
                            </div>
                        </button>
                    </section>
                    <section>
                        <button onClick={() => navigate('/JoinUs')} className={styles.borderButton}>
                            <div className={styles.sectionButton}>
                                ...
                                <div className={styles.sectionBotones}><h3>Unete</h3></div>
                            </div>
                        </button>
                    </section>
                </div>
                <h1 className={styles.title}>PROXIMOS EVENTOS</h1>
            </div>
